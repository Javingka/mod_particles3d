    ...
    if (typeof event !== 'undefined' &&
     ...
     //fetch the particle positions  or create a empty list
      ...
      if (anglesArray[0] == prevAnglesArray[0] && anglesArray[1] == prevAnglesArray[1]) {
        ...
        phiAng = Array.isArray(event.data[7])?event.data[7][0]:Math.PI*.5;
        thetaAng = Array.isArray(event.data[7])?event.data[7][1]:0;
        console.log('new camera angles, phi: ' + phiAng + ' theta: ' + thetaAng);
      }
